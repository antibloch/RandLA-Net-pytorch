...
class CustomPointCloudDataset(torch_data.IterableDataset):
    def __init__(self, points, colors=None, labels=None, num_points=None, batch_size=4, num_classes=20):
        ...
        # We won't use colors as SemanticKITTI doesn't
        ...
        # CRITICAL CHANGE: Don't normalize points!
        # SemanticKITTI doesn't normalize, and the model was trained on unnormalized data
        self.logger.info("Using raw points without normalization to match SemanticKITTI")
    ...
    def __iter__(self):
        ...
        while True:
            try:
                ...
                # CRITICAL CHANGE: Return a tuple matching SemanticKITTI exactly
                # This ensures infer_test_dataset can extract all necessary components
    ...
    def crop_pc(self, points, labels, search_tree, pick_idx):
        ...
        # CRITICAL CHANGE: Use the same crop_pc implementation as in SemanticKITTI
...
def infer_test_dataset():
    ...
    #     [0, 0, 0],       # car - blue
    #     [0, 0, 0],       # bicycle - red
    #     [0, 0, 0],       # motorcycle - magenta
    #     [0, 0, 0],       # truck - cyan
    #     [0, 0, 0],   # other-vehicle - olive
    #     [0, 0, 0],     # person - orange
    #     [0, 0, 0],       # bicyclist - yellow
    #     [0, 0, 0],     # motorcyclist - pink
    #     [0, 1, 0],     # road - gray
    #     [0, 0, 0],     # parking - dark red
    #     [0, 0, 0],     # sidewalk - dark green
    #     [0, 0, 0],     # other-ground - dark blue
    #     [0, 0, 0],   # building - teal
    #     [0, 0, 0],   # fence - purple
    #     [0, 0, 0],       # vegetation - green
    #     [0, 0, 0], # trunk - light gray
    #     [0, 0, 0],   # terrain - light purple
    #     [0, 0, 0],   # pole - light cyan
    #     [0, 0, 0]    # traffic-sign - light yellow
    # ]
    ...
    o3d.io.write_point_cloud("segmented.ply", colored_pc)
